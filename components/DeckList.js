                        ...
                        {({item, index}) => 
                            ...
                            <ListItem selected>
                             <TouchableOpacity style={{flex :1,flexDirection:'row'}} onPress={()=>this.handleDeckSelection(item)}>
                              ...
                              <View style={{flex :1,flexDirection:'row'}}> <View> <Text style={[styles.text,{color:'gray'}]}> 
                              {item.title} </Text>
                               </View>
                               <View>
                                    <Text style={{color:'#D3D3D3'}}> {item.questions.length} {(item.questions.length)>1?'cards':'card'} </Text>
                                     </View> 
                                     </View>
                                      <View > 
                                          ...
                                          <View style={styles.deck}> <Text style={[styles.text,{color:'#D3D3D3'}]}> {item.title} </Text> 
                                          <Text style={{color:'gray'}}> {item.questions.length} {(item.questions.length)>1?'cards':'card'} 
